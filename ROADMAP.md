...
- [x] [frontend ships critically vulnerable dependencies: seroval 1.5.0, vitest 4.0.18, protobufjs 8.0.0](https://github.com/dataclique/moneymentum/issues/479)
      ([#480](https://github.com/dataclique/moneymentum/pull/480))
